...
To ensure a fair and scientific evaluation, **state-of-the-art models from prior research were first reproduced and evaluated**. Based on the observed limitations of these baseline approaches, an **improved Hybrid AOAOA-Optimized Bi-LSTM model** with advanced feature extraction was proposed.

---

## 📚 Baseline Methods (From Literature)
Before proposing our model, we **implemented and evaluated methods reported in prior research**, strictly following their original architectures and training strategies.
...
> **[1] Author(s), “Efficient multi-station air quality prediction in Delhi with wavelet and optimization-based models,” _PLOS ONE_, 2025.**  
> 🔗 https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0330465
...
The proposed model improves upon the literature methods by integrating:
...
2. Wavelet Transform (DB4)  
3. Principal Component Analysis (PCA)  
4. Feature Selection using Hybrid Aquila–Arithmetic Optimization (AOAOA)  
5. Bi-Directional LSTM Prediction  
...
- Literature models perform well but suffer from **feature redundancy and noise**  
- Transformer models require **large datasets for stable performance**  
- GRU is computationally efficient but slightly less accurate  
- **The proposed AOAOA-Bi-LSTM consistently achieves the best performance across stations**
